...
describe('calculateRemainder', () => {
  ...
  it('should be able to cacluate if null', () => {
    const tickets: TicketType[] = [
      { id: 1, price: 25, type: 'Adult' } as TicketType,
    ];
    const result = calculateRemainder(tickets);
  ...
  it('should be able to calculate multiple', () => {
    const tickets: TicketType[] = [
      { id: 1, price: 15, type: 'Child' } as TicketType,
      { id: 1, price: 15, type: 'Child' } as TicketType,
    ];
    const result = calculateRemainder(tickets);
...
describe('discount', () => {
  ...
  it(`Given the amount and number of adults is < 4,
   it should have no discount`, () => {
    const tickets: TicketType[] = [
      { id: 1, price: 25, type: 'Adult' } as TicketType,
      { id: 2, price: 25, type: 'Adult' } as TicketType,
      { id: 3, price: 25, type: 'Adult' } as TicketType,
    ];
    const total = discount(tickets);
  ...
  it should return 30`, () => {
    const tickets: TicketType[] = [
      { id: 1, price: 15, type: 'Child' } as TicketType,
      { id: 2, price: 15, type: 'Child' } as TicketType,
    ];
    const total = discount(tickets);
  ...
  it should return 45`, () => {
    const tickets: TicketType[] = [
      { id: 1, price: 15, type: 'Child' } as TicketType,
      { id: 2, price: 15, type: 'Child' } as TicketType,
      { id: 3, price: 15, type: 'Child' } as TicketType,
    ];
    const total = discount(tickets);
  ...
  it(`Given the amount and number of adults is 4,
   it should return the right amount with discount of 10%`, () => {
    const tickets: TicketType[] = [
      ...
      { id: 2, price: 25, type: 'Adult' } as TicketType,
      { id: 3, price: 25, type: 'Adult' } as TicketType,
      { id: 4, price: 25, type: 'Adult' } as TicketType,
    ];
    const total = discount(tickets);
  ...
  it(`Given the amount and number of adults is 4 and children is 4,
   it should return the right amount is 140`, () => {
    const tickets: TicketType[] = [
      ...
      { id: 3, price: 25, type: 'Adult' } as TicketType,
      { id: 4, price: 25, type: 'Adult' } as TicketType,
      { id: 5, price: 15, type: 'Child' } as TicketType,
      { id: 6, price: 15, type: 'Child' } as TicketType,
      { id: 7, price: 15, type: 'Child' } as TicketType,
      { id: 8, price: 15, type: 'Child' } as TicketType,
    ];
    const total = discount(tickets);
